 ...
 * https://github.com/NServiceBus/NServiceBus/blob/2.0/src/impl/Serializers/NServiceBus.Serializers.XML/MessageSerializer.cs
 * 
...
// ReSharper restore EmptyGeneralCatchClause
        ...
        private List<string> GetNamespaces(object[] messages)
        {
        ...
        private static readonly ILog logger = LogManager.GetLogger(typeof(XmlMessageSerializer).Namespace);
