...
namespace CWServiceBus.Dispatch {
    ...
    public class HandlerInvocationCache
    {
        ...
        private static readonly IDictionary<Type, IDictionary<Type, MethodInfo>> handlerToMessageTypeToHandleMethodMap = new Dictionary<Type, IDictionary<Type, MethodInfo>>();
    }
}
